return require('packer').startup(function()
  ...
  use {'lambdalisue/fern.vim', cmd = {'Fern'}, as='fern'}  -- file explorer
  use {
    'neovim/nvim-lspconfig', -- Collection of configurations for the built-in LSP client
    'williamboman/nvim-lsp-installer', -- to install lsp for language easily
    }

  use {'ms-jpq/coq_nvim', branch='coq'} -- autocompletions

  use 'jiangmiao/auto-pairs' -- auto close brackets, parentathesis,...
  use {
